...
namespace ai
{
    ...
    public:
        ...
        Map* getMap(uint32 instanceId) const { if (!*this) return nullptr; const MapEntry* me = getMapEntry(); if (!me) return nullptr; loadMapAndVMap(instanceId); return sMapMgr.FindMap(mapid, instanceId ? instanceId : (me->Instanceable() ? getFirstInstanceId() : 0)); }
        ...
        bool isDungeon() { const MapEntry* me = getMapEntry(); return me && me->IsDungeon(); }
