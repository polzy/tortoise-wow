...
void TravelMgr::LoadQuestTravelTable()
{
    ...
    sLog.outString("[PB_TRAVEL] before Explore locations");
    ...
    sLog.outString("[PB_TRAVEL] before generateAll");
    sTravelNodeMap.generateAll();

    sLog.outString("[PB_TRAVEL] before printMap");
    sTravelNodeMap.printMap();
    sLog.outString("[PB_TRAVEL] before printNodeStore");
    sTravelNodeMap.printNodeStore();
    sLog.outString("[PB_TRAVEL] before saveNodeStore");
    sTravelNodeMap.saveNodeStore();

    sLog.outString("[PB_TRAVEL] before LoadFishLocations");
    LoadFishLocations();
