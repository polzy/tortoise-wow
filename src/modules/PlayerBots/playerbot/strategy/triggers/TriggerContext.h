...
namespace ai
{
    ...
    public:
        TriggerContext()
        {
            ...
            creators["kurinnaxx mortal wound swap"] = [](PlayerbotAI* ai) { return new KurinnaxxMortalWoundSwapTrigger(ai); };
            creators["twin emperors unbalancing strike swap"] = [](PlayerbotAI* ai) { return new TwinEmperorsUnbalancingStrikeSwapTrigger(ai); };
            ...
            creators["lucifron curse"] = [](PlayerbotAI* ai) { return new LucifronCurseTrigger(ai); };
            creators["lucifron impending doom"] = [](PlayerbotAI* ai) { return new LucifronImpendingDoomTrigger(ai); };
            ...
            creators["gehennas curse"] = [](PlayerbotAI* ai) { return new GehennasCurseTrigger(ai); };
            ...
            creators["shazzrah curse"] = [](PlayerbotAI* ai) { return new ShazzrahCurseTrigger(ai); };
            ...
            creators["golemagg too close"] = [](PlayerbotAI* ai) { return new GolemaggTooCloseTrigger(ai); };
